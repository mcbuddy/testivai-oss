...
This package is part of [testivai-oss](https://github.com/mcbuddy/testivai-oss). It is typically consumed transitively via `@testivai/witness` or `@testivai/witness-playwright` — you don't usually need to install it directly.
