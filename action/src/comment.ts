...
`;
  ...
  comment += '---\n> Pixel-exact comparison — dynamic content (images, fonts, animations) may cause false positives; the DOM-identical hint marks likely render noise. Reviewing with an AI agent? [`@testivai/mcp`](https://github.com/testivai/testivai-oss/blob/main/docs/guides/ai-agents.md) serves this report as structured data (`explain_snapshot`).\n\n*Generated by [TestivAI](https://github.com/testivai/testivai-oss)*\n';
